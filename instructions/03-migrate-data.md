...
1. 新しく作成された **Azure Data Factory** リソースに移動し、 **[スタジオの起動]** を選びます。
...
1. ウィザードの **[ソース]** ステップの **[ソースの種類]** 一覧で、 **[Azure Cosmos DB (NoSQL API)]** を選択します。

1. **[接続]** セクションで、 **[+ 新しい接続]** を選択します。

1. **[新しい接続 (Azure Cosmos DB (NoSQL API))]** ポップアップで、次の値を使用して新しい接続を構成し、 **[作成]** を選択します。
...
1. ウィザードの **[ターゲット]** ステップの **[ターゲットの種類]** 一覧で、 **[Azure Cosmos DB (NoSQL API)]** を選択します。

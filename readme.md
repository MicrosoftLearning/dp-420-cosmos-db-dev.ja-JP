...
ms.locfileid: "138025053"
---
# <a name="dp-420-designing-and-implementing-cloud-native-applications-using-microsoft-azure-cosmos-db"></a>DP-420: Microsoft Azure Cosmos DB を使用したクラウドネイティブ アプリケーションの設計と実装
